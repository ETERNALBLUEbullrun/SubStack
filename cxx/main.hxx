...
static const int susuwuUnitTestsConsoleBit =
	1 << 2; /*   4: `ClassSys.hxx`:`classSysSetConsoleInput()` */
...
static const int susuwuUnitTestsClassFSBit =
	1 << 4; /* 256: `ClassFS.hxx`:`classFSTestsNoexcept()` */
static const int susuwuUnitTestsClassSha2Bit =
	1 << 5; /*  16: `ClassSha2.hxx`:`classSha2TestsNoexcept()` */
static const int susuwuUnitTestsClassResultListBit =
	1 << 6; /*  32: `ClassResultList.hxx`:`classResultListTestsNoexcept()` */
static const int susuwuUnitTestsVirusAnalysisBit =
	1 << 7; /*  64: `VirusAnalysis.hxx`:`virusAnalysisTestsNoexcept()` */
static const int susuwuUnitTestsAssistantCnsBit =
	1 << 8; /* 128: `AssistantCns.hxx`:`assistantCnsTestsNoexcept()` */
